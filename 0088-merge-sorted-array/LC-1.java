...
The cost of sorting a list of length xxx using a built-in sorting algorithm is O(xlog⁡x. Because in this case, we're sorting a list of length m+nm + nm+n, we get a total time complexity of O((n+m)log⁡(n+m).
