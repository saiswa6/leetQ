/*Sort the array, to gather points by losing the minimum power, and gather maximum power on using the points.
Now the task is to divide array into two parts from the front and back ( not necessarily including all the elements ) such that Power of face down cards >= Power of face up cards
To do this i have used prefix sum array and applied binary search on it, to find how many face-up cards i can play with a particular value of Power.*/
