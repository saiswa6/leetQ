...
Space Complexity : O(N). In the worst case space utilized by the stack, the parent pointer dictionary and the ancestor set, would be NNN each, since the height of a skewed binary tree could be N.
